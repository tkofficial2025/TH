      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-4 gap-2">
              <div className="col-span-4 md:col-span-3 relative aspect-[16/10] rounded-xl overflow-hidden bg-gray-200">
                ...
                <div className="absolute bottom-4 left-4 flex gap-2">
                  <span className="px-3 py-1.5 bg-black/50 text-white text-sm rounded-lg">Floor plan</span>
                  <span className="px-3 py-1.5 bg-black/50 text-white text-sm rounded-lg">Street view</span>
                </div>
              </div>
              <div className="col-span-4 md:col-span-1 grid grid-rows-3 gap-2">
                <div className="rounded-lg overflow-hidden bg-gray-200 aspect-video">
                  <div className="w-full h-full bg-gray-300 flex items-center justify-center text-gray-500 text-xs">Floor plan</div>
                </div>
                <div className="rounded-lg overflow-hidden bg-gray-200">
                  <ImageWithFallback src={property.image} alt="" className="w-full h-full object-cover" />
                </div>
            ...
            {/* Rental Fees / Purchase (optional pills) */}
            {source === 'rent' && (
              <div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Balcony', 'Bicycle parking', 'Delivery box', 'Elevator', 'South facing'].map((label) => (
                  <span key={label} className="px-3 py-1.5 bg-gray-900 text-white text-sm rounded-full flex items-center gap-1.5">
                    {label === 'Balcony' && <Building2 className="w-3.5 h-3.5" />}
                    {label === 'Bicycle parking' && <Bike className="w-3.5 h-3.5" />}
                    {label === 'Delivery box' && <Package className="w-3.5 h-3.5" />}
                    {label === 'Elevator' && <ArrowUpDown className="w-3.5 h-3.5" />}
                    {label === 'South facing' && <Maximize2 className="w-3.5 h-3.5" />}
                    {label}
                  </span>
                ))}
              </div>

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-28 pb-20">
        <h1 className="text-4xl font-bold text-gray-900 text-center mb-2">{t('cookie.title')}</h1>
        <p className="text-gray-500 text-center mb-10">{t('cookie.last_updated')}</p>
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">{t('cookie.s1_title')}</h2>
            <p>{t('cookie.s1_p1')}</p>
            <p>{t('cookie.s1_p2')}</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">{t('cookie.s2_title')}</h2>
            <p>{t('cookie.s2_p1')}</p>
            <p className="font-semibold">{t('cookie.s2_specifically')}</p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">{t('cookie.s3_title')}</h2>
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">{t('cookie.s3_h1')}</h3>
            <p>{t('cookie.s3_p1')}</p>
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">{t('cookie.s3_h2')}</h3>
            <p>{t('cookie.s3_p2')}</p>
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">{t('cookie.s3_h3')}</h3>
            <p>{t('cookie.s3_p3')}</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">{t('cookie.s4_title')}</h2>
            <p>{t('cookie.s4_p1')}</p>
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">{t('cookie.s4_ga')}</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">{t('cookie.s4_partners')}</h3>
            <p>{t('cookie.s4_partners_p')}</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">{t('cookie.s5_title')}</h2>
            <p>{t('cookie.s5_p1')}</p>
            <p>{t('cookie.s5_p2')}</p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">{t('cookie.s6_title')}</h2>
